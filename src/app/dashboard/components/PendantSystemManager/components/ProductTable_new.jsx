...
const ProductTable = ({ 
        ...
        <div className="bg-gradient-to-r from-[#50C878]/10 to-[#87CEAB]/10 border-b border-gray-700/50">
          <div className="grid grid-cols-12 gap-4 p-4 text-sm font-semibold text-gray-300">
            <div className="col-span-1 flex items-center">
              <button
                onClick={onSelectAll}
                className={`text-lg ${isAllSelected ? 'text-[#50C878]' : 'text-gray-400'} hover:text-white transition-colors duration-200`}
              >
                  ...
                  <button
                    ...
                    className={`text-lg ${
                      selectedItems.has(item._id) 
                        ? (isSystem ? 'text-[#87CEAB]' : 'text-[#50C878]') 
                        : 'text-gray-400'
  ...
  // Grid View (existing grid implementation would go here if needed)
  return null;
};
