...
const ExplodingProduct = () => {
  ...
  useEffect(() => {
    if (!imagesLoaded || !anime || typeof anime.timeline !== 'function') return;
  ...
  const handleImageLoad = () => {
    const loadedImages = document.querySelectorAll('.product-part[data-loaded="true"]').length;
    if (loadedImages === productParts.length) {
        ...
        {!imagesLoaded && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="text-center text-white">
              ...
              <p className="text-lg">Loading Product Components...</p>
            </div>
          </div>
        )}
...
export default ExplodingProduct;
