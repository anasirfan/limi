        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
          ...
          <div className="flex gap-2">
            <div className="relative">
              ...
              >
                <FaFilter />
                <span className="text-sm">{filterStatus === 'all' ? 'All' : filterStatus === 'saved' ? 'Saved' : 'Ordered'}</span>
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex justify-between items-center text-sm text-gray-400 mb-4">
                  ...
                  <div className="font-semibold text-[#54BB74]">${config.totalPrice.toFixed(2)}</div>
                </div>
              ...
              <div className="p-6">
                <div className="flex flex-col md:flex-row justify-between gap-4 mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold text-[#54BB74]">${selectedConfig.totalPrice.toFixed(2)}</div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    {selectedConfig.products.map((product, index) => (
                      <div key={index} className="flex justify-between items-center bg-[#292929] p-3 rounded-lg">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-[#333] rounded-md flex items-center justify-center text-[#54BB74]">
                            {product.quantity}x
                          </div>
                          <div>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-[#292929] p-3 rounded-lg">
                      ...
                      <div className="text-white font-medium">{selectedConfig.settings.brightness}%</div>
                    ...
                    <div className="bg-[#292929] p-3 rounded-lg">
                      ...
                      <div className="text-white font-medium">{selectedConfig.settings.scene}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  <button
                    className="flex-1 flex items-center justify-center gap-2 bg-[#54BB74] text-white px-4 py-3 rounded-md hover:bg-[#48a064] transition-colors"
                  >
                    <FaShoppingCart />
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 bg-[#292929] border border-[#54BB74] text-[#54BB74] px-4 py-3 rounded-md hover:bg-[#54BB74] hover:text-white transition-colors"
                  >
                    <FaEdit />
                  ...
                  <button
                    className="flex items-center justify-center gap-2 bg-[#292929] border border-gray-700 text-white px-4 py-3 rounded-md hover:bg-[#333] transition-colors"
                  >
                    <FaDownload />
                    <span>Download</span>
                  </button>
                ...
                <div className="mt-6 pt-6 border-t border-gray-700">
                  <div className="text-sm text-gray-400">
                    <p>
                      Note: For full editing capabilities, please use the LIMI mobile app.
                      The web configurator provides basic viewing and ordering functionality.
                    </p>
                  </div>
                </div>
              </div>
