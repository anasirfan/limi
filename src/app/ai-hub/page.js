    ...
    <div className="min-h-screen bg-[#f3ebe2] relative overflow-hidden">
      ...
      >
        <div className="relative z-10 text-center max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-[Amenti] text-[#292929] leading-[0.9] tracking-tight">
              <span className="block font-[Amenti] italic text-[#292929]/90">AI Hub</span>
              <span className="block text-4xl md:text-5xl lg:text-6xl font-[Amenti] font-normal mt-4 text-[#292929]/70">for your</span>
              <span className="block bg-gradient-to-r from-[#54bb74] via-[#93cfa2] to-[#54bb74] bg-clip-text text-transparent font-[Amenti] font-bold">favorite space</span>
            </h1>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              <h2 className="text-5xl md:text-6xl font-[Amenti] text-[#292929] leading-[1.1] tracking-tight">
                <span className="font-[Amenti] italic text-[#292929]/90">Beyond</span>
                <br />
                <span className="font-[Amenti] font-bold">smart lighting</span>
              </h2>
            </div>
            
            <div className="space-y-6 text-lg leading-relaxed">
              <p className="text-[#292929]/70 font-normal">
              ...
              <p className="text-[#292929]/60 font-normal">
