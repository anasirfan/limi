    ...
    <section data-section="mission" className="max-w-4xl mx-auto text-center mb-24">
      ...
      {videoPlaying && (
        ...
        >
          ...
          {/* Modal Container */}
          <motion.div 
            className="relative bg-[#2B2D2F] w-[90%] max-w-4xl rounded-xl shadow-2xl overflow-hidden z-[9999]"
            style={{ maxHeight: 'min(85vh, 800px)', height: 'auto' }}
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
              <div className="flex justify-between items-end">
                <p className="text-white text-lg font-medium">Customer Profile Animation</p>
                <div className="text-white/70 text-xs space-x-3">
