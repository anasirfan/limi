...
const LightingCarousel = () => {
  ...
  useEffect(() => {
    // if (rgbValues.r < 20 && rgbValues.g < 20 && rgbValues.b < 20) {
    //   const minRGBThreshold = 20;
    //   const maxRGBValue = Math.max(rgbValues.r, rgbValues.g, rgbValues.b);
    //   globalThis.offLightOpacity = maxRGBValue < minRGBThreshold ? 1 - maxRGBValue / minRGBThreshold : 0;
    //   setOffLight(true);
    // } else if (rgbValues.r > 240 || rgbValues.g > 240 || rgbValues.b > 240) {
    //   const minRGBThreshold = 240;
    //   const minRGBValue = Math.min(rgbValues.r, rgbValues.g, rgbValues.b);
    //   globalThis.onLightOpacity = minRGBValue > minRGBThreshold ? 1 - minRGBValue / minRGBThreshold : 0;
    //   setOnLight(true);
    // } else   {
    //   setOffLight(false);
    //   setOnLight(false);
    ...
    if (minRGBValue > maxRGBThreshold) {
      ...
      globalThis.whiteOpacity = (minRGBValue - maxRGBThreshold) / (255 - maxRGBThreshold); // Normalize between 0-1
      setOnLight(true);
      setRgbOpacities({
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-full h-full overflow-hidden">
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/images/carouselImages/warm_pure.jpg')",
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/images/carouselImages/warm_mix.jpg')",
                    opacity:
                      warmCoolValue <= 50
                        ? warmCoolValue / 50
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/images/carouselImages/cool_mix.jpg')",
                    opacity:
                      coolValue <= 50 ? coolValue / 50 : (100 - coolValue) / 50,
                  }}
                />
                ...
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/images/carouselImages/cool_pure.jpg')",
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full h-full overflow-hidden">
                    ...
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url('/images/lighting/light-off.jpg')",
