      ...
      <AnimatePresence>
        {openDropdown === step?.id && (
          <motion.div
            ...
            className="absolute right-full mr-4 bg-gray-800 rounded-lg shadow-xl z-50 overflow-hidden
              sm:right-full sm:mr-3 sm:top-0
              xs:fixed xs:left-0 xs:right-0 xs:bottom-0 xs:mr-0 xs:mt-0 xs:rounded-t-lg xs:rounded-b-none"
            style={{ 
              width: '280px',
