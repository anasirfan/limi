...
export const TractionSection = () => {
  ...
  return (
    <motion.section
      ref={ref}
      className="relative py-32 px-6 lg:px-12 bg-gradient-to-b from-[#292929] to-[#1a1a1a]"
    >
...
export const StrategySection = () => {
  ...
  return (
    <motion.section
      ref={ref}
      className="relative py-32 px-6 lg:px-12 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]"
    >
      <div className="max-w-7xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          ...
          className="text-center mb-20"
        >
          <h2 className="text-5xl md:text-6xl font-[Amenti] text-white leading-[1.1] tracking-tight mb-6">
            Our <span className="font-[Amenti] italic text-[#54bb74]">Multi-Layered</span>
            <br />
            <span className="font-[Amenti] font-normal text-white/80">AI & Infrastructure Moat</span>
          </h2>
        </motion.div>
              ...
              <div className={`lg:col-span-9 space-y-6 ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                <div className="space-y-3">
                  <div className="inline-flex items-center gap-3 px-4 py-2 bg-[#54bb74]/10 rounded-full border border-[#54bb74]/20">
                    ...
                    <span className="text-sm font-medium text-white/80 tracking-wide">{layer.subtitle.toUpperCase()}</span>
                  </div>
                  
                  <h3 className="text-4xl md:text-5xl font-[Amenti] text-white leading-tight">
                    {layer.title}
                  </h3>
                </div>
                
                <p className="text-xl text-white/70 leading-relaxed font-normal max-w-3xl">
                  {layer.description}
                </p>
              </div>
            </motion.div>
...
export const OpportunitySection = () => {
  ...
  return (
    <motion.section
      ref={ref}
      className="relative py-32 px-6 lg:px-12 bg-gradient-to-b from-[#0a0a0a] to-[#1a1a1a]"
    >
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-[Amenti] text-white leading-[1.1] tracking-tight">
            <span className="font-[Amenti] italic text-[#54bb74]">Consolidating</span> a Fragmented,
            <br />
            <span className="font-[Amenti] font-normal text-white/80">Multi-Hundred-Billion-Dollar Market</span>
          </h2>
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            <motion.p
              ...
              className="text-xl text-white/70 leading-relaxed font-normal"
            >
...
export const TeamSection = () => {
  ...
  return (
    <motion.section
      ref={ref}
      className="relative py-32 px-6 lg:px-12 bg-gradient-to-b from-[#1a1a1a] to-[#292929]"
    >
      <div className="max-w-7xl mx-auto">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
        ...
        >
          <h2 className="text-5xl md:text-6xl font-[Amenti] text-white leading-[1.1] tracking-tight mb-6">
            ...
            <br />
            <span className="font-[Amenti] font-normal text-white/80">for This Mission</span>
          </h2>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-12">
          {team.map((member, index) => (
            ...
            >
              <div className="relative p-8 bg-white/5 backdrop-blur-xl rounded-[2rem] border border-white/10 hover:bg-white/10 transition-all duration-700 hover:scale-[1.02]">
                {/* Photo Placeholder */}
                <div className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-[#54bb74]/20 to-[#93cfa2]/20 rounded-3xl flex items-center justify-center border border-white/10">
                  <div className="text-center">
                    ...
                    <p className="text-xs text-white/40">Professional Photo</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-2xl font-[Amenti] font-bold text-white">
                      {member.name}
                    </h3>
        ...
        >
          <div className="space-y-8">
            <h2 className="text-5xl md:text-6xl font-[Amenti] text-white leading-[1.1] tracking-tight">
              ...
              <br />
              <span className="font-[Amenti] font-normal text-white/80">to build the OS for the Physical World</span>
            </h2>
            
            <p className="text-xl text-white/70 leading-relaxed font-normal max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <Link href="https://limilighting.com" target="_blank">
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="px-12 py-5 bg-white/10 backdrop-blur-xl text-white rounded-2xl font-medium text-lg border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
